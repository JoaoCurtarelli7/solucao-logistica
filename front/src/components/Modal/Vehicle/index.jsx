    ...
    if (vehicle) {
      ...
      form.setFieldsValue({
        ...
        insuranceExpiry: vehicle.insuranceExpiry
          ? dayjs(vehicle.insuranceExpiry)
          : null,
        tachographCalibrationExpiry: vehicle.tachographCalibrationExpiry
          ? dayjs(vehicle.tachographCalibrationExpiry)
          : null,
        oilChangeEngineDate: vehicle.oilChangeEngineDate
          ? dayjs(vehicle.oilChangeEngineDate)
          : null,
        oilChangeGearboxDate: vehicle.oilChangeGearboxDate
          ? dayjs(vehicle.oilChangeGearboxDate)
          : null,
    ...
    form
      ...
      .then((values) => {
        const formattedValues = {
          ...
          docExpiry: values.docExpiry
            ? values.docExpiry.format("YYYY-MM-DD")
            : null,
  ...
  return (
    ...
    >
      <Form form={form} layout="vertical">
        ...
        <Row gutter={16}>
          <Col span={12}>
            <Form.Item name="insuranceExpiry" label="Vencimento do Seguro">
              <DatePicker
                style={{ width: "100%" }}
                format="DD/MM/YYYY"
        ...
        <Row gutter={16}>
          ...
          <Col span={8}>
            <Form.Item
              name="oilChangeDifferentialDate"
              label="Troca Óleo Diferencial"
            >
              <DatePicker
                style={{ width: "100%" }}
                format="DD/MM/YYYY"
