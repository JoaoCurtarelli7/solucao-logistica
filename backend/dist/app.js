...
const loadDocumentAi_1 = require("./routes/loadDocumentAi");
...
const loadBillingClosing_1 = require("./routes/loadBillingClosing");
...
const maintenanceServicePreset_1 = require("./routes/maintenanceServicePreset");
...
exports.app.register(loadDocumentAi_1.loadDocumentAiRoutes);
...
exports.app.register(loadBillingClosing_1.loadBillingClosingRoutes);
exports.app.register(truck_1.truckRoutes);
exports.app.register(maintenance_1.maintenanceRoutes);
exports.app.register(maintenanceServicePreset_1.maintenanceServicePresetRoutes);
